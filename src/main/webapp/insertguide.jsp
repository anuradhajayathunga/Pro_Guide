                        ...
                        <div class="row clearfix">                                                  
                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="field-inner">
                                    <input type="text" name="name" value="" placeholder="S.P.Perera" >
                                </div>
                            </div>
                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                <div class="f-label">Email Address </div>
                                <div class="field-inner">
                                    <input type="email" name="email" value="" placeholder="perera99@gmail.com" >
                                </div>
                            </div>
                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                <div class="f-label">Phone Number</div>
                                <div class="field-inner">
                                    <input type="text" name="phone" value="" placeholder="078XXXXXXX" >
                                </div>
                            </div>
                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                <div class="f-label">UserName</div>
                                <div class="field-inner">
                                    <input type="text" name="uid" value="" placeholder="#PereXXXX" >
                                </div>
                            </div>
                             ...
                             <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="field-inner">
                                    <input type="password" name="psw" value="" placeholder="XXXXXXXX" >
                                </div>
                            </div>                           
