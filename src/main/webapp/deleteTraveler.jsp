                         ...
                         <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="field-inner">
		                            ...
		                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
		                                ...
		                                <div class="field-inner">
		                                    <input type="text" name="nic" value="<%=nic %>" placeholder="" readonly>
		                                </div>
		                            </div>
		                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
		                            ...
		                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
		                                ...
		                                <div class="field-inner">
		                                    <input type="text" name="userName" value="<%=country %>" placeholder=">" readonly>
		                                </div>
		                            </div>
		                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
		                                <div class="f-label">UserName</div>
		                                <div class="field-inner">
		                                    <input type="text" name="userName" value="<%=userName %>" placeholder="" readonly>
		                                </div>
		                            </div>
